...
export const STORY_BRANCHES: StoryBranch[] = [
  ...
  },
  {
    ...
    chip: '임플란트가 실패했어요',
    icon: 'rotate-left',
    empathy: '큰마음 먹고 한 치료가 다시 흔들릴 때의 막막함, 어디서부터 다시 시작해야 할지 모르는 마음을 압니다.',
    guide: '구강악안면외과 전문의가 망가진 임플란트·염증 병소를 정리하고, 뼈 상태부터 회복시키는 단계적 재건을 계획합니다.',
    treatment: 'implant',
    treatmentName: '임플란트 재수술',
    doctor: 'kwon-minsu',
    doctorName: '권민수 대표원장',
    faq: { q: '실패한 임플란트도 다시 할 수 있나요?', a: '기존 임플란트 실패, 부러진 픽스처, 주변 염증이 있어도 제거와 회복을 거쳐 재수술을 검토할 수 있습니다. 정밀 진단 후 단계적으로 계획합니다.' },
  },
  {
    id: 'crooked',
    chip: '치아가 가지런하지 않아요',
