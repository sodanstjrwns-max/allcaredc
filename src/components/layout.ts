...
export function headTags(meta: Meta) {
  ...
  return html`
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Fraunces:ital,opsz,wght@0,9..144,300..600;1,9..144,300..500&family=Nanum+Myeongjo:wght@400;700;800&family=DM+Mono:wght@300;400;500&display=swap" />
