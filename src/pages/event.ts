...
export function EventIndex(events: EventItem[]) {
  ...
  ${PageHero({
    ...
    title: '이벤트',
    desc: '올케어치과의 진행 중인 이벤트와 혜택 안내입니다.',
  })}
  ...
  return Page({
    title: '이벤트 | 올케어치과',
    description: '약수역 올케어치과 진행 중인 이벤트·혜택 안내. 정확한 비용과 진료 내용은 상담 시 안내드립니다.',
    path: '/events',
