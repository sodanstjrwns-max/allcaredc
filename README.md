...
- **디자인 시스템**: **Heritage Private Clinic v9** (2026.06 디자인 슈퍼 업그레이드) — 고급 프라이빗 클리닉/헤리티지 브랜드 문법. 아이보리·웜베이지의 면 분할 + 딥네이비 단일 잉크 + 브라스 헤어라인 장식(다이아 모티프 `.hh-diamond`, 오프셋 액자 프레임). 다크 시네마 히어로 → **라이트 스플릿 패널 히어로**(`hero--heritage`: 우측 44% 베이지 패널, 네이비 액자 사진, 클램프 타이포 3.2–7.6rem). 챕터형 내러티브(Prologue → Ch.00~05 → Epilogue) 골격은 v8에서 계승.
